...
exports.createSafeFallbackTemplate = createSafeFallbackTemplate;
exports.createEmergencyFallback = createEmergencyFallback;
exports.createBoundaryTemplate = createBoundaryTemplate;
function createSafeFallbackTemplate(context) {
...
function createBoundarySafeFallback(context) {
    return {
        mirror: {
...
function createEarlyConversationFallback(context) {
    return {
        mirror: {
...
function createStructuredFallback(context) {
    return {
        mirror: {
...
function createDefaultSafeFallback(context) {
    return {
        mirror: {
...
//# sourceMappingURL=safeFallback.js.map